 ...
 * installing into a scratch project that is not this repo. The Foundation
 * door has no registry item yet, so it links to the docs instead of
 * printing a command that would fail — a broken install command on a
 * landing page costs more trust than a missing one.
 *
    ...
    doors: [
      {
        ...
        blurb:
          "The Foundation, the token master and the code-to-Figma contract — the bounded configuration space this whole argument rests on. Documented now; a one-command setup is still being built.",
        icon: "sliders",
      },
      {
        id: "governance",
