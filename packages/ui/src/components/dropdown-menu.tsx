...
function DropdownMenuSubTrigger({
  ...
  return (
    ...
    >
      {children}
      <Icon name="chevron-right" strokeWidth={2} className="rtl:rotate-180 ms-auto" />
    </DropdownMenuPrimitive.SubTrigger>
  )
}
