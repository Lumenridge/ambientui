...
import { useIsMobile } from "@ambient-ui/ui/hooks/use-mobile"
import { cn } from "@ambient-ui/ui/lib/utils"
import { Button } from "@ambient-ui/ui/components/button"
import { Input } from "@ambient-ui/ui/components/input"
import { Separator } from "@ambient-ui/ui/components/separator"
import {
  Sheet,
  SheetContent,
  SheetDescription,
  SheetHeader,
  SheetTitle,
} from "@ambient-ui/ui/components/sheet"
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          "relative w-(--sidebar-width) bg-transparent transition-[width] duration-(--motion-page) ease-(--motion-ease)",
      ...
      <div
        ...
        data-side={side}
        className={cn(
          "fixed inset-y-0 z-10 hidden h-svh w-(--sidebar-width) transition-[left,right,width] duration-(--motion-page) ease-(--motion-ease) data-[side=left]:left-0 data-[side=left]:group-data-[collapsible=offcanvas]:left-[calc(var(--sidebar-width)*-1)] data-[side=right]:right-0 data-[side=right]:group-data-[collapsible=offcanvas]:right-[calc(var(--sidebar-width)*-1)] md:flex",
...
function SidebarTrigger({
  ...
  return (
    <Button
      ...
      {...props}
    >
      <Icon name="sidebar" strokeWidth={2} className="rtl:rotate-180" />
...
function SidebarRail({ className, ...props }: React.ComponentProps<"button">) {
  ...
  return (
    <button
      ...
      className={cn(
        "absolute inset-y-0 z-20 hidden w-4 transition-all ease-(--motion-ease) group-data-[side=left]:-right-4 group-data-[side=right]:left-0 after:absolute after:inset-y-0 after:start-1/2 after:w-[2px] hover:after:bg-sidebar-border sm:flex ltr:-translate-x-1/2 rtl:-translate-x-1/2",
