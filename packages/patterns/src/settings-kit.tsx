...
export function SettingsRow({
  ...
  return (
    <div className={cn("px-5 py-4", className)}>
      {/* flex-wrap: a wide control beside a shrink-0 box crushed the
          description to a word a line on phone widths — wrapping drops
          the control onto its own row instead, and costs desktop nothing */}
